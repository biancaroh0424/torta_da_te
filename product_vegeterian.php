    ...
    <section class="product_filter">
        ...
        <div>
            <form method="post" name="1hour_filter" id="action" name="action">
                ...
                <?php
                $sql = "SELECT DISTINCT tag FROM vegeterian ORDER BY tag";
                ...
                <ul class="input_group">
                <?php
                $sql = "SELECT DISTINCT size FROM vegeterian ORDER BY size";
                ...
                <ul class="input_group">
                <?php
                $sql = "SELECT DISTINCT flavor FROM vegeterian ORDER BY flavor";
                ...
                <ul class="input_group">
                <?php
                $sql = "SELECT DISTINCT price_group FROM vegeterian ORDER BY price_group";
...
$(document).ready(function(){
    ...
    $(".product_check").click(function(){
        ...
        $.ajax({
            url:'../torta_da_te/action_product_vegeterian.php',
            type: 'POST',
